...
# Вывод
После выполнения данной лабораторной работы мы познакомились таким типом документов как SRS. Мы не только научились 
ориентироваться в нём, но и поняли стандарты для создания требований к ПО. Уверены, что это поможет нам успешнее коммуницировать с заказчиком.
Мы уверены, что полученные знания помогут нам в планировании требований для порабощения тюленей
...
* [Software Requirements Specification](#software-requirements-specification)
  ...
  * [Specific Requirements](#specific-requirements)
    * [Functionality](#functionality)
      * [ID: FR1 - Поисковики должны находить систему в интернете.](#id-fr1---поисковики-должны-находить-систему-в-интернете)
      * [ID: FR2.1 - Регистрация с помощью почты](#id-fr21---регистрация-с-помощью-почты)
      * [ID: FR2.2 - Регистрация с помощью сторонних сервисов](#id-fr22---регистрация-с-помощью-сторонних-сервисов)
      * [ID: FR3 - Личный кабинет пользователя](#id-fr3---личный-кабинет-пользователя)
      * [ID: FR4.1 - Создание вопросов](#id-fr41---создание-вопросов)
      * [ID: FR4.2 - Редактирование вопросов](#id-fr42---редактирование-вопросов)
      * [ID: FR5.1 - Создание ответов](#id-fr51---создание-ответов)
      * [ID: FR5.2 - Редактирование ответов](#id-fr52---редактирование-ответов)
      * [ID: FR6 - Рейтинговая система](#id-fr6---рейтинговая-система)
      * [ID: FR7 - Поиск похожих вопросов.](#id-fr7---поиск-похожих-вопросов)
      * [ID: FR8 - Создание организации](#id-fr8---создание-организации)
      * [ID: FR9 - Система репутации пользователей](#id-fr9---система-репутации-пользователей)
      * [ID: FR10 - Улучшение постов](#id-fr10---улучшение-постов)
      * [ID: FR11 - Система вознаграждений](#id-fr11---система-вознаграждений)
      * [ID: FR12 - Поиск по вопросам](#id-fr12---поиск-по-вопросам)
      * [ID: FR13 - Поиск по критериям](#id-fr13---поиск-по-критериям)
      * [ID: FR14 - Поиск вопроса по тегам](#id-fr14---поиск-вопроса-по-тегам)
      * [ID: FR15 - Модерация контента](#id-fr15---модерация-контента)
    * [Security](#security)
...
И. Соммервилл - Инженерия программного обеспечения 6-е издание
...
Так система не зависит от конкретного аппаратного обеспечения,
...
Внешнее взаимодействие с пользователями происходит с использованием электронной почты в следующих случаях:
- подтверждение пользователя письмом
- уведомления о новых вопросах, ответах и комментариях
- уведомления об изменении рейтинге
...
#### ID: FR1 - Поисковики должны находить систему в интернете.

**DESC:** Ссылки на систему должны быть в топе для поисковиков.

**RAT:** Благодаря этой функции новые пользователи смогут узнавать о системе 

**TIME:** 2 story-point

**RISK**: технологический риск нечеткого взаимодействия с поисковой системой - 
рейтинг сайта может зависеть от множества параметров, не все из которых публично доступны

#### ID: FR2.1 - Регистрация с помощью почты

**DESC:** Система должна предоставлять пользователям возможность регистрироваться используя свою учётную

**RAT:** Пользователь должен иметь возможность зарегистрироваться.

**TIME:** 1 story-point, 40 чел*час (эталонная задача)

**RISK**: бизнес-риск утечки ПД пользователей

#### ID: FR2.2 - Регистрация с помощью сторонних сервисов

**DESC:** Система должна предоставлять пользователям возможность регистрироваться используя свои учетные записи
из других сервисов: Google, VK, Github.
...
#### ID: FR3 - Личный кабинет пользователя

**DESC:** Система должна предоставлять пользователям личный кабинет, в котором пользователь может 
видеть свой рейтинг, награды, вопросы и ответы, изменять личные данные.

**RAT:** Обеспечить пользователю возможность ведения профиля на площадке

**DEP:** FR2

**TIME:** 2 story-point

**RISK**: бизнес-риск утечки ПД пользователя 

#### ID: FR4.1 - Создание вопросов

**DESC:** Система должна позволять пользователям создавать и помечать тегами свои вопросы.
...
**RISK**: бизнес-риск использования платформы не по назначению через публикацию неправомерного контента

#### ID: FR4.2 - Редактирование вопросов

**DESC:** Система должна позволять пользователям редактировать существующие свои вопросы.

**TIME:** 2 story-point

**DEP:** FR4.1

**RISK**: технологический риск при ошибках разграничения доступа, ведущий к доступу пользователей к чужому контенту

#### ID: FR5.1 - Создание ответов

**DESC:** Система должна позволять пользователям создавать свои ответы на вопросы.

**RAT:** Пользователь должен иметь возможность отвечать на вопросы других пользователей
...
#### ID: FR5.2 - Редактирование ответов

**DESC:** Система должна позволять пользователям изменять существующие свои ответы на вопросы.
...
**RISK**: бизнес-риск неправильной оценки прав пользователей исходя из их рейтинга 
и принципов изменения рейтинга на платформе, приводящий к неправильной самоорганизации платформы

#### ID: FR7 - Поиск похожих вопросов.
...
**RISK**: технический риск при некачественной реализации на платформе будут образовываться группы 
одинаковых вопросов, что ведет к неудобству использования пользователями.


#### ID: FR8 - Создание организации
...
**RISK** Бизнес риски: негативное поведение в рамках организации. 

#### ID: FR9 - Система репутации пользователей

**DESC:** Система должна иметь механизм контроля репутации пользователей, основанной на их вкладе в развитие сообщества.

**RAT:** Система с рейтингом внесёт соревновательный характер в систему. Это, в свою очередь, будет мотивировать
пользователей формулировать ответ, полностью покрывающий все аспекты вопроса.

**TIME:** 3 story-point

**RISK** Прямые риски: несправедливое формирование репутации из-за ошибок в алгоритмах. 

#### ID: FR10 - Улучшение постов
...
**RISK** Бизнес риск: правильные ответы могу быть заменены на неправильные или вопросы могу быть коронально изменены,
тогда все предыдущие ответы потеряют смысл.

#### ID: FR11 - Система вознаграждений
...
**RISK** Бизнес риск: вознаграждения будут слишком простые: большинство пользователей получит все вознаграждения,
или слишком сложные: даже самую простую награду будет сложно получить. Это не сможет мотивировать пользователей
участвовать в развитии системы

#### ID: FR12 - Поиск по вопросам
...
**RISK** Прямой риск: низкая скорость поиска по вопросам из-за особенностей алгоритмов и количества данных.

#### ID: FR13 - Поиск по критериям
...
**RISK** Прямые риск: недостаточная эффективность фильтрации и сортировки из-за особенностей алгоритмов
и количества данных. 

#### ID: FR14 - Поиск вопроса по тегам
...
**RISK** прямые риски: Неправильное отображение вопросов по тегам из-за ошибок в логике поиска.

#### ID: FR15 - Модерация контента
...
**RISK** Бизнес риск: пропуск нежелательного контента из-за неаккуратности модераторов.

### Security

#### ID: SEC1 - безопасность передачи данных

**DESC:** при взаимодействии с сервисом извне, все коммуникации должны происходить по HTTPS,
...
**RAT:** пользователи не должны иметь возможности непредусмотренным требованиями образом изменять состояние системы
...
**DESC:** Возможность поиска вопроса должна быть доступна пользователю на всех основных страницах на видном месте
...
**DESC:** Система должна предоставлять возможность осуществлять поиск по всем подсистемам
...
**DESC:** Система должна быть одной из первых ссылок при поиске вопросов соответствующих тематик.

**RAT:** Это позволит пользователям чаще пользоваться системой.
...
**DESC:** доступность системы должна быть более 97%
...
для проблем препятствующих работе системы - до 2 суток.
