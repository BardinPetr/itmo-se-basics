...
**DESC:** канал связи должен обеспечивать суммарно 
...
Программный код является коммерческой тайной компании и не распространяется, так же как и исполняемые файлы, базы данных и другие ресурсы.

Весь контент создаваемый пользователями на площадке, распространяется под лицензией "Creative Commons Attribution-ShareAlike"
