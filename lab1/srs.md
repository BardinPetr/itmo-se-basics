...
**DESC:** Система должна предоставлять пользователям возможность регистрироваться как через электронную почту.

**RAT:** Упростить процесс регистрации и побудить больше пользователей регистрироваться.

**TIME:** 1 story-point, 25 чел*час (эталонная задача)
...
TODO : разденьено
#### ID: FR4 - Создание и редактирование вопросов
...
#### ID: FR5 - Создание и редактирование ответов
