...
**TIME:** 1 story-point, 20 чел*час (эталонная задача)

TODO
#### ID: FR2 - Регистрация с помощью сторонних сервисов

**DESC:** Система должна предоставлять пользователям возможность регистрироваться используя свои учетные записи из других сервисов таких как Google.
TODO конкретика
...
TODO убрать конкретику элементов
...
**DESC:** доступность системы должна быть более 99.99% TODO меньще
...
для проблем препятствующих работе системы - до 1 часа.TODO меньще
